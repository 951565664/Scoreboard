...
/******/ 	var hotCurrentHash = "325f928ed5f674af6680"; // eslint-disable-line no-unused-vars
...
console.log('Scoreboard', _scoreboard2.default);
	...
	_createClass(NumberItem, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: _index2.default["animation-num-item-box"] },
				_react2.default.createElement(
					'ul',
					{ className: _index2.default['currentNum-' + this.state.currentNum], style: { transitionDuration: transitionDuration } },
					function () {
						return new Array(10).fill(1).map(function (item, index) {
							return _react2.default.createElement(
								'li',
								{ key: Date.now() + index, style: numberStyle },
								_react2.default.createElement(
									'div',
									{ className: _index2.default["li-inner"] },
									index
								)
							);
						});
...
var Scoreboard = function (_React$Component2) {
	...
	_createClass(Scoreboard, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: _index2.default["animation-num-box"], style: style },
				numberArr.map(function (item, key) {
